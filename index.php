...
define('WEB_FOLDER','/~alumno/ejercicios/tp-abm/'); //with trailing slash pls

//===============================================
// Other Settings
//===============================================
$GLOBALS['sitename']='Ortega - Productos';
...
function getdbh() {
  if (!isset($GLOBALS['dbh']))
    try {
      ...
      $db = require('db_conf.php');
      $GLOBALS['dbh'] = new PDO($db['uri'], $db['user'], $db['password']);
...
//===============================================
$controller = new Controller(APP_PATH.'controllers/',WEB_FOLDER,'productos','listar');
